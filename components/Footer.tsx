...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-900 text-white pt-16 md:pt-24 pb-8 md:pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-14 mb-10 md:mb-16">
          <div className="space-y-5 md:space-y-7">
            <div className="flex items-center gap-2 md:gap-3">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-teal-500 to-teal-700 rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <span className="text-lg md:text-2xl font-extrabold tracking-tight">Teeth Care</span>
            </div>
            ...
            <div className="flex gap-3 md:gap-4 mt-2">
              {[
                ...
                <a
                  key={social.icon}
                  href="#"
                  className={`w-8 h-8 md:w-10 md:h-10 bg-slate-800 rounded-full flex items-center justify-center transition-colors ${social.color}`}
        ...
        <div className="pt-8 md:pt-12 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 text-slate-500 text-xs md:text-base font-medium">
